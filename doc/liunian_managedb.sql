...
CREATE TABLE `think_roleauthor` (
  ...
  FOREIGN KEY (`RoleId`) REFERENCES `think_role` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE, 
  FOREIGN KEY (`MenuId`) REFERENCES `think_sysmenu` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE
